...
type User struct {
	ID        int64     `json:"id"`
	Nickename string    `xorm:"varchar(64) comment '昵称'" json:"nickname" user_register:"required"`
	Email     string    `xorm:"varchar(255) comment '邮箱'" json:"email" user_register:"required"`
	Password  string    `xorm:"varchar(64) commnet '登录密码'" json:"password" user_register:"required"`
